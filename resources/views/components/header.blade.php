    ...
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
            <a class="me-3 py-2 link-body-emphasis text-decoration-none"
               href="{{ route('pages.services') }}">Services</a>
            <a class="me-3 py-2 link-body-emphasis text-decoration-none"
            ...
            @else
                <a class="me-3 py-2 btn btn-outline-primary text-decoration-none
                   href="{{ route('register') }}">Register</a>
                <a class="me-3 py-2 btn btn-primary text-decoration-none login-btn"
